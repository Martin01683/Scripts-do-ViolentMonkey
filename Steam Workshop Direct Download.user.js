...
(function() {
    ...
    // ========================================================================
    const translations = {
        en: { checkingVersion: 'Checking Version...', mirrorError: 'Mirror Error', requestMod: 'Request Mod', modNotListed: 'Mod not listed. Click to request.', download: 'Download', downloadWarning: 'Download', modUpdated: 'MOD UP TO DATE', modOutdated: 'MOD OUTDATED', requestUpdate: 'Request Update', labelSteam: 'Steam:', labelCache: 'Cache Status:', cacheSteam: 'Steam:', justNow: 'just now', minAgo: 'min ago', steamError: 'Unverified', steamErrorTip: 'Steam API unreachable. Version not verified.', mirrorNoDate: 'Mirror Without Date', mirrorNoDateTip: 'Could not verify mirror version date.', clearCache: 'Update Cache', cacheCooldown: 'Update cache ({s}s)', idlePaused: 'Paused (Idle)', idleActive: 'Active', exactTimeWarn: 'Mirror missing time.<br>Precision uncertain.', modUnavailable: 'Mod Unavailable', modUnavailableTip: 'Not found in the mirror', modUnavailableSubTip: 'No mirror site/forum registered to submit this request', modNotListedSubTip: 'Read the Site/Forum rules before requesting', invalidLink: 'Invalid Link', invalidLinkTip: 'Mirror returned an invalid or unsafe link.', checkedMirrors: 'Mirrors checked:', bestAvailable: 'Best available version selected', requestUpdateTip: 'Read the Site/Forum rules before requesting', noForumTip: 'No forum registered to request updates for this game.', clearCacheTip: 'Clears verification data and rechecks.' },
        pt: { checkingVersion: 'Verificando versão...', mirrorError: 'Erro no Mirror', requestMod: 'Pedir Mod', modNotListed: 'Mod não listado. Clique para pedir.', download: 'Baixar', downloadWarning: 'Baixar', modUpdated: 'MOD ATUALIZADO', modOutdated: 'MOD DESATUALIZADO', requestUpdate: 'Pedir Atualização', labelSteam: 'Steam:', labelCache: 'Status do Cache:', cacheSteam: 'Steam:', justNow: 'agora', minAgo: 'min atrás', steamError: 'Sem Verificar', steamErrorTip: 'Falha na API Steam. Versão não verificada.', mirrorNoDate: 'Mirror sem data', mirrorNoDateTip: 'Não foi possível verificar a versão do mirror.', clearCache: 'Limpar Cache', cacheCooldown: 'Limpar cache ({s}s)', idlePaused: 'Pausado (Inativo)', idleActive: 'Ativo', exactTimeWarn: 'O mirror não contém hora.<br>Precisão incerta.', modUnavailable: 'Mod Indisponível', modUnavailableTip: 'Não encontrado no mirrors', modUnavailableSubTip: 'Nenhum site/fórum de mirrors cadastrado<br>para fazer este pedido', modNotListedSubTip: 'Leia as regras do Site/Fórum antes de pedir', invalidLink: 'Link Inválido', invalidLinkTip: 'O mirror retornou um link inválido ou inseguro.', checkedMirrors: 'Mirrors verificados:', bestAvailable: 'Melhor versão disponível selecionada', requestUpdateTip: 'Leia as regras do Site/Fórum antes de pedir', noForumTip: 'Nenhum fórum cadastrado para solicitar atualizações deste jogo.', clearCacheTip: 'Limpa os dados de verificação e refaz a checagem.' },
        es: { checkingVersion: 'Comprobando versión...', mirrorError: 'Error en Mirror', requestMod: 'Pedir mod', modNotListed: 'Mod no listado. Haz clic para pedirlo.', download: 'Descargar', downloadWarning: 'Descargar', modUpdated: 'MOD ACTUALIZADO', modOutdated: 'MOD DESACTUALIZADO', requestUpdate: 'Pedir actualización', labelSteam: 'Steam:', labelCache: 'Estado del caché:', cacheSteam: 'Steam:', justNow: 'ahora', minAgo: 'min atrás', steamError: 'No verificado', steamErrorTip: 'Fallo en la API de Steam. Versión no verificada.', mirrorNoDate: 'Mirror sin fecha', mirrorNoDateTip: 'No se pudo verificar la versión del mirror.', clearCache: 'Actualizar caché', cacheCooldown: 'Actualizar caché ({s}s)', idlePaused: 'Pausado (Inactivo)', idleActive: 'Activo', exactTimeWarn: 'Mirror sin hora.<br>Precisión incierta.', modUnavailable: 'Mod no disponible', modUnavailableTip: 'No encontrado en el mirror', modUnavailableSubTip: 'No hay sitio/foro de mirrors registrado para hacer esta solicitud', modNotListedSubTip: 'Lee las reglas del sitio/foro antes de pedir', invalidLink: 'Enlace Inválido', invalidLinkTip: 'El mirror devolvió un enlace inválido o inseguro.', checkedMirrors: 'Mirrors verificados:', bestAvailable: 'Mejor versión disponible seleccionada', requestUpdateTip: 'Lee las reglas del sitio/foro antes de pedir', noForumTip: 'No hay foro registrado para solicitar actualizaciones de este juego.', clearCacheTip: 'Borra los datos de verificación y vuelve a comprobar.' },
        fr: { checkingVersion: 'Vérification de la version...', mirrorError: 'Erreur Mirror', requestMod: 'Demander le mod', modNotListed: 'Mod non listé. Cliquez pour le demander.', download: 'Télécharger', downloadWarning: 'Télécharger', modUpdated: 'MOD À JOUR', modOutdated: 'MOD OBSOLÈTE', requestUpdate: 'Demander une mise à jour', labelSteam: 'Steam:', labelCache: 'État du cache:', cacheSteam: 'Steam:', justNow: 'à l\'instant', minAgo: 'min', steamError: 'Non vérifié', steamErrorTip: 'Erreur de l\'API Steam. Version non vérifiée.', mirrorNoDate: 'Mirror sans date', mirrorNoDateTip: 'Impossible de vérifier la version du mirror.', clearCache: 'Mettre à jour le cache', cacheCooldown: 'Mettre à jour ({s}s)', idlePaused: 'En pause (Inactif)', idleActive: 'Actif', exactTimeWarn: 'Heure manquante dans le mirror.<br>Précision incertaine.', modUnavailable: 'Mod indisponible', modUnavailableTip: 'Introuvable dans le mirror', modUnavailableSubTip: 'Aucun site/forum de mirrors enregistré pour faire cette demande', modNotListedSubTip: 'Lisez les règles du site/forum avant de faire une demande', invalidLink: 'Lien invalide', invalidLinkTip: 'Le mirror a renvoyé un lien invalide ou non sécurisé.', checkedMirrors: 'Mirrors vérifiés:', bestAvailable: 'Meilleure version disponible sélectionnée', requestUpdateTip: 'Lisez les règles du site/forum avant de faire une demande', noForumTip: "Aucun forum enregistré pour demander des mises à jour de ce jeu.", clearCacheTip: 'Efface les données de vérification et relance la vérification.' },
        de: { checkingVersion: 'Version wird geprüft...', mirrorError: 'Mirror-Fehler', requestMod: 'Mod anfragen', modNotListed: 'Mod nicht gelistet. Zum Anfragen klicken.', download: 'Herunterladen', downloadWarning: 'Herunterladen', modUpdated: 'MOD AKTUELL', modOutdated: 'MOD VERALTET', requestUpdate: 'Update anfragen', labelSteam: 'Steam:', labelCache: 'Cache-Status:', cacheSteam: 'Steam:', justNow: 'gerade eben', minAgo: 'Min. her', steamError: 'Nicht verifiziert', steamErrorTip: 'Steam API nicht erreichbar. Version nicht verifiziert.', mirrorNoDate: 'Mirror ohne Datum', mirrorNoDateTip: 'Mirror-Version konnte nicht verifiziert werden.', clearCache: 'Cache aktualisieren', cacheCooldown: 'Cache aktualisieren ({s}s)', idlePaused: 'Pausiert (Inaktiv)', idleActive: 'Aktiv', exactTimeWarn: 'Mirror ohne Uhrzeit.<br>Präzision ungewiss.', modUnavailable: 'Mod nicht verfügbar', modUnavailableTip: 'Nicht im Mirror gefunden', modUnavailableSubTip: 'Keine Mirror-Seite/Forum registriert, um diese Anfrage zu stellen', modNotListedSubTip: 'Lies die Regeln der Seite/des Forums, bevor du eine Anfrage stellst', invalidLink: 'Ungültiger Link', invalidLinkTip: 'Der Mirror hat einen ungültigen oder unsicheren Link zurückgegeben.', checkedMirrors: 'Überprüfte Mirrors:', bestAvailable: 'Beste verfügbare Version ausgewählt', requestUpdateTip: 'Lies die Regeln der Seite/des Forums, bevor du eine Anfrage stellst', noForumTip: 'Für dieses Spiel ist kein Forum für Update-Anfragen registriert.', clearCacheTip: 'Löscht die Überprüfungsdaten und prüft erneut.' },
        it: { checkingVersion: 'Controllo versione...', mirrorError: 'Errore Mirror', requestMod: 'Richiedi mod', modNotListed: 'Mod non presente. Clicca per richiederla.', download: 'Scarica', downloadWarning: 'Scarica', modUpdated: 'MOD AGGIORNATA', modOutdated: 'MOD NON AGGIORNATA', requestUpdate: 'Richiedi aggiornamento', labelSteam: 'Steam:', labelCache: 'Stato cache:', cacheSteam: 'Steam:', justNow: 'adesso', minAgo: 'min fa', steamError: 'Non verificato', steamErrorTip: 'API Steam non raggiungibile. Versione non verificata.', mirrorNoDate: 'Mirror senza data', mirrorNoDateTip: 'Impossibile verificare la versione del mirror.', clearCache: 'Aggiorna cache', cacheCooldown: 'Aggiorna cache ({s}s)', idlePaused: 'In pausa (Inattivo)', idleActive: 'Attivo', exactTimeWarn: 'Mirror senza ora.<br>Precisione incerta.', modUnavailable: 'Mod non disponibile', modUnavailableTip: 'Non trovato nel mirror', modUnavailableSubTip: 'Nessun sito/forum di mirror registrato per effettuare questa richiesta', modNotListedSubTip: 'Leggi le regole del sito/forum prima di richiedere', invalidLink: 'Link non valido', invalidLinkTip: 'Il mirror ha restituito un link non valido o non sicuro.', checkedMirrors: 'Mirrors controllati:', bestAvailable: 'Migliore versione disponibile selezionata', requestUpdateTip: 'Leggi le regole del sito/forum prima di richiedere', noForumTip: 'Nessun forum registrato per richiedere aggiornamenti di questo gioco.', clearCacheTip: 'Cancella i dati di verifica e ricontrolla.' },
        nl: { checkingVersion: 'Versie controleren...', mirrorError: 'Mirrorfout', requestMod: 'Mod aanvragen', modNotListed: 'Mod staat niet in de lijst. Klik om aan te vragen.', download: 'Downloaden', downloadWarning: 'Downloaden', modUpdated: 'MOD IS UP-TO-DATE', modOutdated: 'MOD IS VEROUDERD', requestUpdate: 'Update aanvragen', labelSteam: 'Steam:', labelCache: 'Cache-status:', cacheSteam: 'Steam:', justNow: 'zojuist', minAgo: 'min geleden', steamError: 'Ongecontroleerd', steamErrorTip: 'Steam API onbereikbaar. Versie niet gecontroleerd.', mirrorNoDate: 'Mirror zonder datum', mirrorNoDateTip: 'Kon de mirrorversie niet verifiëren.', clearCache: 'Cache bijwerken', cacheCooldown: 'Cache bijwerken ({s}s)', idlePaused: 'Gepauzeerd (Inactief)', idleActive: 'Actief', exactTimeWarn: 'Mirror mist tijd.<br>Precisie onzeker.', modUnavailable: 'Mod niet beschikbaar', modUnavailableTip: 'Niet gevonden in de mirror', modUnavailableSubTip: 'Geen mirror-site/forum geregistreerd om deze aanvraag te doen', modNotListedSubTip: 'Lees de regels van de site/het forum voordat je een aanvraag doet', invalidLink: 'Ongeldige link', invalidLinkTip: 'De mirror gaf een ongeldige of onveilige link terug.', checkedMirrors: 'Gecontroleerde mirrors:', bestAvailable: 'Beste beschikbare versie geselecteerd', requestUpdateTip: 'Lees de regels van de site/het forum voordat je een aanvraag doet', noForumTip: 'Geen forum geregistreerd om updates voor dit spel aan te vragen.', clearCacheTip: 'Wist de verificatiegegevens en controleert opnieuw.' },
        pl: { checkingVersion: 'Sprawdzanie wersji...', mirrorError: 'Błąd Mirrora', requestMod: 'Poproś o mod', modNotListed: 'Mod nie jest na liście. Kliknij, aby poprosić.', download: 'Pobierz', downloadWarning: 'Pobierz', modUpdated: 'MOD AKTUALNY', modOutdated: 'MOD NIEAKTUALNY', requestUpdate: 'Poproś o aktualizację', labelSteam: 'Steam:', labelCache: 'Stan pamięci podręcznej:', cacheSteam: 'Steam:', justNow: 'właśnie teraz', minAgo: 'min temu', steamError: 'Niezweryfikowane', steamErrorTip: 'API Steam niedostępne. Wersja niezweryfikowana.', mirrorNoDate: 'Mirror bez daty', mirrorNoDateTip: 'Nie można zweryfikować wersji mirrora.', clearCache: 'Zaktualizuj pamięć', cacheCooldown: 'Zaktualizuj pamięć ({s}s)', idlePaused: 'Wstrzymano (Bezczynny)', idleActive: 'Aktywny', exactTimeWarn: 'Brak godziny w mirrorze.<br>Precyzja niepewna.', modUnavailable: 'Mod niedostępny', modUnavailableTip: 'Nie znaleziono w mirrorze', modUnavailableSubTip: 'Brak zarejestrowanej strony/forum mirrora do złożenia tej prośby', modNotListedSubTip: 'Przeczytaj zasady strony/forum przed złożeniem prośby', invalidLink: 'Nieprawidłowy link', invalidLinkTip: 'Mirror zwrócił nieprawidłowy lub niebezpieczny link.', checkedMirrors: 'Sprawdzone mirrory:', bestAvailable: 'Wybrano najlepszą dostępną wersję', requestUpdateTip: 'Przeczytaj zasady strony/forum przed złożeniem prośby', noForumTip: 'Brak zarejestrowanego forum do proszenia o aktualizacje tej gry.', clearCacheTip: 'Czyści dane weryfikacji i sprawdza ponownie.' },
        ru: { checkingVersion: 'Проверка версии...', mirrorError: 'Ошибка зеркала', requestMod: 'Запросить мод', modNotListed: 'Мода нет в списке. Нажмите, чтобы запросить.', download: 'Скачать', downloadWarning: 'Скачать', modUpdated: 'МОД АКТУАЛЕН', modOutdated: 'МОД УСТАРЕЛ', requestUpdate: 'Запросить обновление', labelSteam: 'Steam:', labelCache: 'Статус кэша:', cacheSteam: 'Steam:', justNow: 'только что', minAgo: 'мин назад', steamError: 'Не проверено', steamErrorTip: 'API Steam недоступен. Версия не проверена.', mirrorNoDate: 'Зеркало без даты', mirrorNoDateTip: 'Не удалось проверить версию зеркала.', clearCache: 'Обновить кэш', cacheCooldown: 'Обновить кэш ({s}s)', idlePaused: 'Пауза (Бездействие)', idleActive: 'Активно', exactTimeWarn: 'На зеркале нет времени.<br>Точность не гарантируется.', modUnavailable: 'Мод недоступен', modUnavailableTip: 'Не найдено на зеркале', modUnavailableSubTip: 'Сайт/форум зеркала для этого запроса не зарегистрирован', modNotListedSubTip: 'Прочитайте правила сайта/форума перед запросом', invalidLink: 'Неверная ссылка', invalidLinkTip: 'Зеркало вернуло неверную или небезопасную ссылку.', checkedMirrors: 'Проверенные зеркала:', bestAvailable: 'Выбрана лучшая доступная версия', requestUpdateTip: 'Прочитайте правила сайта/форума перед запросом', noForumTip: 'Для этой игры не зарегистрирован форум для запроса обновлений.', clearCacheTip: 'Очищает данные проверки и выполняет проверку заново.' },
        tr: { checkingVersion: 'Sürüm kontrol ediliyor...', mirrorError: 'Mirror hatası', requestMod: 'Mod iste', modNotListed: 'Mod listede yok. İstemek için tıkla.', download: 'İndir', downloadWarning: 'İndir', modUpdated: 'MOD GÜNCEL', modOutdated: 'MOD ESKİ', requestUpdate: 'Güncelleme iste', labelSteam: 'Steam:', labelCache: 'Önbellek Durumu:', cacheSteam: 'Steam:', justNow: 'şimdi', minAgo: 'dk önce', steamError: 'Doğrulanmadı', steamErrorTip: 'Steam API\'sine ulaşılamıyor. Sürüm doğrulanmadı.', mirrorNoDate: 'Tarihsiz Mirror', mirrorNoDateTip: 'Mirror sürümü doğrulanamadı.', clearCache: 'Önbelleği Güncelle', cacheCooldown: 'Önbelleği güncelle ({s}s)', idlePaused: 'Duraklatıldı (Boşta)', idleActive: 'Aktif', exactTimeWarn: 'Mirror\'da saat yok.<br>Kesinlik belirsiz.', modUnavailable: 'Mod mevcut değil', modUnavailableTip: 'Mirror\'da bulunamadı', modUnavailableSubTip: 'Bu isteği yapmak için kayıtlı mirror sitesi/forumu yok', modNotListedSubTip: 'İstemeden önce site/forum kurallarını okuyun', invalidLink: 'Geçersiz Bağlantı', invalidLinkTip: 'Mirror geçersiz veya güvensiz bir bağlantı döndürdü.', checkedMirrors: 'Kontrol edilen mirror\'lar:', bestAvailable: 'Mevcut en iyi sürüm seçildi', requestUpdateTip: 'İstemeden önce site/forum kurallarını okuyun', noForumTip: 'Bu oyun için güncelleme istemek üzere kayıtlı forum yok.', clearCacheTip: 'Doğrulama verilerini temizler ve yeniden kontrol eder.' },
        zh: { checkingVersion: '正在检查版本...', mirrorError: '镜像错误', requestMod: '请求 Mod', modNotListed: 'Mod 未收录。点击请求。', download: '下载', downloadWarning: '下载', modUpdated: 'MOD 已是最新', modOutdated: 'MOD 已过期', requestUpdate: '请求更新', labelSteam: 'Steam:', labelCache: '缓存状态:', cacheSteam: 'Steam:', justNow: '刚刚', minAgo: '分钟前', steamError: '未验证', steamErrorTip: 'Steam API 无法访问。版本未验证。', mirrorNoDate: '镜像无日期', mirrorNoDateTip: '无法验证镜像版本。', clearCache: '更新缓存', cacheCooldown: '更新缓存 ({s}s)', idlePaused: '已暂停（空闲）', idleActive: '活跃', exactTimeWarn: '镜像缺少时间。<br>精度不确定。', modUnavailable: '模组不可用', modUnavailableTip: '镜像中未找到', modUnavailableSubTip: '未注册可用于提交此请求的镜像网站/论坛', modNotListedSubTip: '请求前请阅读网站/论坛规则', invalidLink: '链接无效', invalidLinkTip: '镜像返回了无效或不安全的链接。', checkedMirrors: '已检查的镜像:', bestAvailable: '已选择最佳可用版本', requestUpdateTip: '请求前请阅读网站/论坛规则', noForumTip: '此游戏没有注册可请求更新的论坛。', clearCacheTip: '清除验证数据并重新检查。' },
        zh_tw: { checkingVersion: '正在檢查版本...', mirrorError: '鏡像錯誤', requestMod: '請求 Mod', modNotListed: 'Mod 未收錄。點擊請求。', download: '下載', downloadWarning: '下載', modUpdated: 'MOD 已是最新', modOutdated: 'MOD 已過期', requestUpdate: '請求更新', labelSteam: 'Steam:', labelCache: '快取狀態:', cacheSteam: 'Steam:', justNow: '剛剛', minAgo: '分鐘前', steamError: '未驗證', steamErrorTip: 'Steam API 無法訪問。版本未驗證。', mirrorNoDate: '鏡像無日期', mirrorNoDateTip: '無法驗證鏡像版本。', clearCache: '更新快取', cacheCooldown: '更新快取 ({s}s)', idlePaused: '已暫停（閒置）', idleActive: '活躍', exactTimeWarn: '鏡像缺少時間。<br>精度不確定。', modUnavailable: '模組不可用', modUnavailableTip: '鏡像中未找到', modUnavailableSubTip: '未註冊可用於提交此請求的鏡像網站/論壇', modNotListedSubTip: '請求前請閱讀網站/論壇規則', invalidLink: '連結無效', invalidLinkTip: '鏡像返回了無效或不安全的連結。', checkedMirrors: '已檢查的鏡像:', bestAvailable: '已選擇最佳可用版本', requestUpdateTip: '請求前請閱讀網站/論壇規則', noForumTip: '此遊戲沒有註冊可請求更新的論壇。', clearCacheTip: '清除驗證資料並重新檢查。' },
        ja: { checkingVersion: 'バージョン確認中...', mirrorError: 'ミラーエラー', requestMod: 'Modをリクエスト', modNotListed: 'Modが未登録です。クリックしてリクエスト。', download: 'ダウンロード', downloadWarning: 'ダウンロード', modUpdated: 'MODは最新です', modOutdated: 'MODは古いです', requestUpdate: '更新をリクエスト', labelSteam: 'Steam:', labelCache: 'キャッシュ状態:', cacheSteam: 'Steam:', justNow: 'たった今', minAgo: '分前', steamError: '未検証', steamErrorTip: 'Steam APIにアクセスできません。バージョン未検証。', mirrorNoDate: '日付のないミラー', mirrorNoDateTip: 'ミラーのバージョンを確認できませんでした。', clearCache: 'キャッシュを更新', cacheCooldown: 'キャッシュ更新 ({s}s)', idlePaused: '一時停止（アイドル）', idleActive: 'アクティブ', exactTimeWarn: 'ミラーに時間がありません。<br>精度は不確実です。', modUnavailable: 'Mod利用不可', modUnavailableTip: 'ミラーに見つかりません', modUnavailableSubTip: 'このリクエストを送信できるミラーのサイト/フォーラムが登録されていません', modNotListedSubTip: 'リクエストする前にサイト/フォーラムのルールをお読みください', invalidLink: '無効なリンク', invalidLinkTip: 'ミラーが無効または安全でないリンクを返しました。', checkedMirrors: '確認したミラー:', bestAvailable: '利用可能な最適なバージョンを選択しました', requestUpdateTip: 'リクエストする前にサイト/フォーラムのルールをお読みください', noForumTip: 'このゲームには更新をリクエストできる登録済みフォーラムがありません。', clearCacheTip: '検証データを消去して再チェックします。' },
        ko: { checkingVersion: '버전 확인 중...', mirrorError: '미러 오류', requestMod: '모드 요청', modNotListed: '모드가 목록에 없습니다. 클릭해서 요청하세요.', download: '다운로드', downloadWarning: '다운로드', modUpdated: 'MOD 최신 상태', modOutdated: 'MOD 오래됨', requestUpdate: '업데이트 요청', labelSteam: 'Steam:', labelCache: '캐시 상태:', cacheSteam: 'Steam:', justNow: '방금', minAgo: '분 전', steamError: '확인 안 됨', steamErrorTip: 'Steam API에 접근할 수 없습니다. 버전이 확인되지 않았습니다.', mirrorNoDate: '날짜 없는 미러', mirrorNoDateTip: '미러 버전을 확인할 수 없습니다.', clearCache: '캐시 업데이트', cacheCooldown: '캐시 업데이트 ({s}s)', idlePaused: '일시 정지 (유휴)', idleActive: '활성', exactTimeWarn: '미러에 시간이 없습니다.<br>정확도 불확실.', modUnavailable: '모드 사용 불가', modUnavailableTip: '미러에서 찾을 수 없습니다', modUnavailableSubTip: '이 요청을 보낼 미러 사이트/포럼이 등록되어 있지 않습니다', modNotListedSubTip: '요청하기 전에 사이트/포럼 규칙을 읽어주세요', invalidLink: '잘못된 링크', invalidLinkTip: '미러가 유효하지 않거나 안전하지 않은 링크를 반환했습니다.', checkedMirrors: '확인된 미러:', bestAvailable: '가장 적합한 버전을 선택했습니다', requestUpdateTip: '요청하기 전에 사이트/포럼 규칙을 읽어주세요', noForumTip: '이 게임에 대해 업데이트를 요청할 수 있는 등록된 포럼이 없습니다.', clearCacheTip: '확인 데이터를 지우고 다시 확인합니다.' }
    };
    ...
    const TemplateEngine = {
        ...
        createMirrorCheckNotice(consultedMirrors, showBestAvailable = true, needsTopSeparator = true) {
            ...
            // "Não encontrado no mirror" logo acima.
