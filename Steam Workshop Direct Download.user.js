...
(function() {
    ...
    async function renderWidget(container, modId, isCard) {
        ...
        if (!exactTime) {
            exactTimeWarningHtml = `<div style="color: #F59E0B; font-size: 11px; margin-top: 6px; padding-top: 6px; border-top: 1px dashed #3d4450; white-space: normal !important; line-height: 1.4;">${t.exactTimeWarn}</div>`;
        }
